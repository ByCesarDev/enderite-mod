...
function teleportPlayerWithSword(player, charge) {
    ...
    try {
        ...
        // Center core mist
        runCmd(`particle minecraft:dragon_breath_trail ${player.location.x} ${player.location.y + 0.5} ${player.location.z}`);
        runCmd(`particle minecraft:dragon_breath_trail ${player.location.x} ${player.location.y + 1.5} ${player.location.z}`);
